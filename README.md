...
| ホスティング | Vite dev server `:3000` | Firebase Hosting |
| 認証 | Firebase Auth Emulator `:9099` | Firebase Auth + Identity Platform |
| DB | Firestore Emulator `:8080` | Firestore |
| ストレージ | MinIO `:9000` (S3互換) | Firebase Storage |
| OG/サムネ取得 | dev用 Express プロキシ `:8787` | Cloud Functions |
